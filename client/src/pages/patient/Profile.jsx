    ...
    <div style={{ backgroundColor: '#f4f7f6', minHeight: '100vh' }}>
      <div className="container" style={{ maxWidth: '900px', margin: '0 auto', padding: '20px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '15px', marginBottom: '40px' }}>
          {[
            { href: '/patient/booking', icon: '📅', label: 'Schedule an Appointment' },
            { href: '/patient/visits', icon: '📄', label: 'Visit History' },
            { href: '/patient/billing', icon: '💳', label: 'Make a Payment' },
            { href: '/patient/update-profile', icon: '⚙️', label: 'Update Information' },
          ].map(card => (
            <a
              key={card.href}
              href={card.href}
              style={{
                ...
                boxShadow: '0 2px 5px rgba(0,0,0,0.05)', textDecoration: 'none',
                color: '#333', display: 'flex', flexDirection: 'column',
                alignItems: 'center', justifyContent: 'center',
                border: '1px solid #ddd', transition: 'background 0.2s',
              }}
            >
